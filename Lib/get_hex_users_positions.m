...
function [userPos,vertPos] = get_hex_users_positions(num_users,cellCenter,interSiteDist)
...
userPos = [cellCenter(1)+(2*rand(1,num_users)-1)*r; cellCenter(2)+(2*rand(1,num_users)-1) * r]; % generate random points 
